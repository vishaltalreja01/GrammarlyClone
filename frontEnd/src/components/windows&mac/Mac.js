...
import image1 from '../../images2/mac1.png'
import image2 from '../../images2/mac2.png'
import image3 from '../../images2/mac3.png'
import image4 from '../../images2/mac4.png'
import mac from '../../images2/macimage.png'
import Navbar from '../navbar/Navbar'
import Footer from '../footer/Footer'
const Mac = () => {
    const [questionData, setQuestionData] = useState([
        {
            question: 'How do I install  Writeophonic on my Mac?',
            answer: 'Download Writeophonic, open the file, and follow the installation prompts. If you need help, check out our step-by-step support article.',
            isOpen: false
        },
        {
            question: 'Does Writeophonic work in Microsoft Word on my Mac?',
            answer: 'Yes,you can use Grammerly in Microsoft Word and Outlook on Mac',
            isOpen: false
        },
        {
            question: 'Is Writeophonic Mac free?',
            answer: 'Yes, you can use the free version of Writeophonic for Mac as long as you want. If you are looking for more in-depth writing suggestions and customizable features, check out Writeophonic Premium ',
            isOpen: false
        },
        {
        ...
        {
            question: 'Can I use Writeophonic in Safari?',
        ...
        {
            question: 'What version of Mac do I need?',
            answer: 'To install Writeophonic for Mac on your computer, you need to be using macOS 10.12 or newer.Write Your Best with Writeophonic',
            isOpen: false
        },
            ...
            <div>
                <div className="hero">
                    <div className="left">
                        ...
                        >
                            Writeophonic for  Mac
                            <br />
                           
                        </h1>
                        <p style={{ fontSize: "20px", lineHeight: "32px" }}>
                        An all-in-one writing assistant that works on your desktop and in your browser. Use it in apps, word processors, email clients, and more.</p>
                        <button
                    style={{
                    ...
                    disabled
                >
                    <span style={{ fontWeight: "" }}>Not Availbe</span>
                ...
                <div
                    className="icons"
                    style={{
                        paddingBlock: "125px",backgroundColor:'#3260a8',color:'white'
                    }}
                >
                    <div className="tag">
                        <img
                ...
                <div>
                    ...
                    <div className="hero">
                        ...
                        <div className="left1_" style={{ padding: "25px" }}>
                            ...
                            <p style={{ fontSize: "20px", lineHeight: "32px" }}>
                                Tone is tricky to convey in writing. Writeophonic includes a tone
                                detector to help you understand how your message will sound to a
                                reader—before you hit send.
                            </p>
                        </div>
                        <div className="right">
                            <img
                ...
                >
                    ...
                    <p
                        style={{ fontSize: "20px", lineHeight: "32px", marginTop: "30px" }}
                    >
                        With the free plan, you get a monthly quota of prompts to power
                        WriteophonicGO, your generative AI writing assistant. Use these prompts
                        across apps and websites to compose drafts, rewrite text, generate
                        ideas, and quickly respond to emails.
                    </p>
                </div>
                <div>
                    <div className="hero">
