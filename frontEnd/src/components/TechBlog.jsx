...
const TechBlog = () => {
  return (
    <>
    <Navbar/>
      <h1 className="_20LGq-h1Title" style={{marginLeft:"100px",marginRight:"200px"}}>Writeophonic Engineering Blog</h1>
      <div className="_1J0o0-front" style={{display: "flex",marginLeft:"100px",marginRight:"200px"}}>
  <a
  ...
  >
    ...
    />
    <br />
    <div style={{backgroundColor:"white",textDecoration:"none",color:"black",fontSize:"32px"}}>
    <span className="_2dJp5-category" style={{fontSize:"12px"}}>NLP/ML</span><br />
    <span className="_1gk_E-title">
  ...
  <div className="_2KzgF-caption" style={{fontSize:"32px"}}>Featured</div>
  <ul className="_2UtT5-listContainer" style={{ listStyleType: 'none', padding: 0 ,fontSize:"24px"}}>
    <li style={{ textDecoration: 'none' }}>
      <div style={{ backgroundColor: '#ffffff', padding: '10px' }}>
        <a href="/blog/engineering/security-infrastructure-aws/" style={{ textDecoration: 'none', color: '#000' }}>
          <span style={{color:"green"}}>Infrastructure</span>
          <br />
          <span>Security Operations in an AWS Environment</span>
        </a>
      </div>
    </li>
    <li style={{ textDecoration: 'none' }}>
      <div style={{ backgroundColor: '#ffffff', padding: '10px' }}>
        <a href="/blog/engineering/product-mindset-for-engineers/" style={{ textDecoration: 'none', color: '#000' }}>
          <span style={{color:"green"}}>Team</span>
          <br />
          <span>
            How to Leverage a Product Mindset for a Successful Engineering Career
          </span>
        </a>
      </div>
    </li>
    <li style={{ textDecoration: 'none' }}>
      <div style={{ backgroundColor: '#ffffff', padding: '10px' }}>
        <a href="/blog/engineering/gec-tag-not-rewrite/" style={{ textDecoration: 'none', color: '#000' }}>
          <span style={{color:"green"}}>NLP/ML</span>
          <br />
          <span>Grammatical Error Correction: Tag, Not Rewrite</span>
        </a>
      </div>
    </li>
  </ul>
          ...
          <li className="_2Pp64-listItem">
            ...
            >
              ...
              />
                ...
                <span className="_1gCLm-category">Infrastructure</span><br />
              <span className="bPt6Z-title">
                How Writeophonic Engineering’s “Platform University” Helps Us Build
                Faster
              </span>
                </div>
      ...
      <div>
        <button style={{marginLeft:"500px",fontSize:"32px",backgroundColor:"white",borderRadius:"10px",marginTop:"20px",marginRight:"100px",width:"600px",marginBottom:"30px",color:'green'}}>
        <a
      className="_2kB5f-basicButton MNdu8-schemeSecondaryOnLight _3VN5q-shapeRound d-Rvr-sizeLarge _2O9mn-readMoreButton"
      href="/blog/engineering/?page=2#post_feed" style={{textDecoration:"none",color:'green'}}
    >
      Read More
    </a>
        </button>
 ...
 <br />
 <div className="_3uLgu-container" style={{ display: 'flex', alignItems: 'center', backgroundColor: "rgb(97, 97, 227)" ,marginBottom:"50px",marginLeft:"200px",marginRight:"200px"}}>
      <img
        className="_2WUeQ-photo"
        alt=""
        src="https://contenthub-static.grammarly.com/assets/img/3bca78fa5b651b5192d1712880d86f54/careers.jpg"
        srcSet="https://contenthub-static.grammarly.com/assets/img/3bca78fa5b651b5192d1712880d86f54/careers.jpg 1x, https://contenthub-static.grammarly.com/assets/img/45e5a89c4efdd79855f802c8ab7e7961/careers@2x.jpg 2x"
      />
      <div className="_148RL-label" >
        <div className="_1FH_O-text" style={{marginLeft:"100px",fontSize:"42px",color:"white"}}>Shape the way millions of people communicate every day!</div>
        <button type="button" className="_2kB5f-basicButton _2vGxi-schemePrimaryOnDark _3VN5q-shapeRound d-Rvr-sizeLarge" style={{fontSize:"32px",backgroundColor:"white",borderRadius:"10px" ,marginTop:"30px" ,marginBottom:"10px",marginLeft:"200px"}}>
          <div className="_2eFD_-buttonCircle"></div>
          <span className="sFCs1-buttonContent">Explore open roles</span>
        </button>
      </div>
    </div>
    <Footer/>
